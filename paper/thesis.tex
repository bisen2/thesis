...
\chapter{Experimental Methods}
    ...
    \begin{wrapfigure}{r}{0.4\textwidth}
        \centering
        \vspace{-1cm}
        \includegraphics[width=0.35\textwidth]{images/schematic.png}
...
%         \end{figure}
    ...
    \section{Multi-cavity Devices}
        ...
        \begin{figure}
            ...
            \caption{Forward emission spectra of devices with two (a), three (b), four (c), and five (d) cavities.}
        \end{figure}
...
\appendix
\chapter{Component Spectra of Angular Resolved Graphs}
